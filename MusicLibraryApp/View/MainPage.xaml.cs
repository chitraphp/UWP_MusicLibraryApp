    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void AddPlayListButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == ContentDialogResult.Primary)
            {
                ...
                vm.AddPlayList(new PlayList(plname.ToString()));
                /***{
        ...
        private void PlayListNames_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            vm.currentPlayListSongs = pl.PlayListSongs; //Change this for the SOngs of the PlayList
        ...
        private async void PlaySongBtnInPivot_Click(object sender, RoutedEventArgs e)
        {
            
            var item = (sender as FrameworkElement).DataContext;
            selectedSongIndex = listViewArtists.Items.IndexOf(item);
            var list = vm.Artists.SelectMany(d => d).ToList();
            Song songInContext =(Song) list.ElementAt(selectedSongIndex);
        ...
        private void PlayListNames_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            //vm.currentPlayList = pl;
            //CHITRA JUst CHANGE THIS LINE
            vm.GetplayListSongs(pl);
           // vm.currentPlayListSongs = pl.PlayListSongs; //Change this for the SOngs of the PlayList
           // PlayListGridView.ItemsSource = vm.currentPlayListSongs;

            TextBlockPlayList.Text = pl.PlayListName + "  Playlist ";
            testing.Text = vm.playLists.ElementAt(0).PlayListSongs.Count.ToString();
        ...
        private void PlayListPicker_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            var y = song.ShortArtistName;
            PlayList playList = (sender as ListView).SelectedItem as PlayList;
            vm.AddSongtoPlayList(playList, song);
            //testing.Text = vm.playLists.ElementAt(0).PlayListSongs.ElementAt(0).ShortArtistName;
            int x = vm.Itemscount();
